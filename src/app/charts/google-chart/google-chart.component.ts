...
export class GoogleChartComponent implements OnInit {
  ...
  line_ChartData = [
    ['Year', 'Sales', 'Expenses', 'tooltip'],
    ['2004', 1000, 400, 'selva'],
    ['2005', 1170, 460, 'selva'],
    ['2006', 660, 1120, 'ss'],
    ['2007', 1030, 540, 'ss']];
  ldata = [
    ['type', 'Target',{'type': 'string', 'role': 'tooltip', 'p': {'html': false}}, 'Actual',{'type': 'string', 'role': 'tooltip', 'p': {'html': false}}],
    ["3-09", 10,'Target -3-09-2017	120 GSM', 17,'Actual - 3-09-2017	120 GSM'],
    ...
    // ["	31-09-2035	", 120, 123],
    // ["	1/14/2017	", 120, 124],
     ["	31-09", 20,'Tar - 3-09-2017	120 GSM',  25,'Act -31-09-2037']
  ];
  lineData =
  ([['X', '1', '2', '3', '4', '5', '6'],
  [1, 2, 3, 4, 5, 6, 7],
