...
export class ServerService {
    ...
    putTallyData(product) {
        ...
        return this.http.put('http://lowcost-env.nc9myxcv3i.us-west-2.elasticbeanstalk.com/services/tallyservice/tally',
            json, {
                headers: headers
            })
            .map(res => res.json());
    ...
    getTallyDaybook() {
        return this.http.get('http://LowCost-env.nc9myxcv3i.us-west-2.elasticbeanstalk.com/services/tallyservice/daybook')
    ...
    updateTallyDaybook(key) {
        ...
        return this.http.put('http://LowCost-env.nc9myxcv3i.us-west-2.elasticbeanstalk.com/services/tallyservice/daybook',
            json, {
                headers: headers
            })
            .map(res => res.json());
    ...
    setFlagTallyDaybook(key) {
        ...
        return this.http.put('http://LowCost-env.nc9myxcv3i.us-west-2.elasticbeanstalk.com/services/tallyservice/daybook/' + key,
            {
                headers: headers
            })
            .map(res => res.json());
    ...
    authenticateUser(user) {
        ...
        return this.http.post('http://lowcost-env.nc9myxcv3i.us-west-2.elasticbeanstalk.com/services/tallyservice/login',
            json, {
                headers: headers
            })
            .map(res => res.json());
